...
// Start Function Get All Products
...
getCategoryID(cId:number):IProducts[] {
  ...
  if (cId==0) {
    ...
    return this.listOfProduct.filter(pro => pro.category == cId);

  }
}


// Start Function Get One Product With Id 
getId(pId:number) {


  this.listOfProduct.find(onePr => onePr.id == pId)
